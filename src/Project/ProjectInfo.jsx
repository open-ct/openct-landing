...
class ProjectInfo extends React.PureComponent {
  ...
  render() {
    const { project, menu } = this.state;
    return (
      <DocumentTitle title="Project">
        <div style={{ backgroundColor: '#f2f4f5', height: '100vh' }}>
          <Header isMobile={this.state.isMobile} />
          <div style={{ margin: '20px', maxWidth: '1200px', alignSelf: 'center' }}>
            <Card hoverable >
              <Row>
                <Col span={6}>
                  <Image
                ...
                <Col flex="auto" >
                  ...
                  <p style={{ fontSize: '13px', color: 'gray' }}>发布时间：{project.createTime}</p>
                  <p>
            ...
            <Menu onClick={this.handleClick} selectedKeys={menu} mode="horizontal" style={{ marginTop: '20px' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '20px' }}>
              ...
              {menu === 'project-outline' ? <ProjectOutline /> : null}
              {menu === 'project-evaluation' ? <ProjectEvaluation /> : null}
            </div>
          </div>
